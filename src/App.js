...
function App() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Jason Anak Rolls | Full-stack Developer</title>
        <meta name="description" content="Welcome to Jason Anak Rolls's portfolio website. I'm Jason Anak Rolls, a passionate full-stack developer showcasing my projects, skills, and experience." />
        <meta name="keywords" content="Jasonanakrolls, Jasonrolls, jasonanakrolls.in, Jason Anak Rolls,jasonrolls portfolio, Full stack Developer" />
        <meta name="author" content="Jason Anak Rolls" />
        <meta property="og:title" content="Jason Anak Rolls - Portfolio" />
        ...
        <meta name="twitter:title" content="Jason Anak Rolls - Portfolio" />
