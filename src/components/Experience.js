...
// Import images
import rocketechImg from '../Assets/rocketech.png';
import empatImg from '../Assets/empat.png';
import ventionImg from '../Assets/vention.png';
import nextzenImg from '../Assets/nextzen.jpg';

const Experience = () => {
  // Function to get the correct image based on company name
  const getCompanyImage = (company) => {
    const imageMap = {
      'Rocketech': rocketechImg,
      'Empat': empatImg,
      'Vention': ventionImg,
      'NextZen Minds': nextzenImg,
    };
